            ...
            {allTypes.map((items) => (
                <Link to={`/${items.id}`} className={'w-1/4'}>
                    <div className={
                        ...
                        <div className={
                            type === items.id ? "flex justify-center items-center flex-col w-full py-3 border-t-2 border-zomato-400" : "flex justify-center items-center flex-col py-3 border-t-2 border-white"
                        }>
                            {items.icon}
